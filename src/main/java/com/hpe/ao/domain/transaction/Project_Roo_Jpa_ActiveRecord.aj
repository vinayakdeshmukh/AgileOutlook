...
privileged aspect Project_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Project.fieldNames4OrderClauseFilter = java.util.Arrays.asList("leadName", "program", "teamAveragePointDaily", "averagePointsPerStory", "averageTeamCount", "averageTeamSize");
